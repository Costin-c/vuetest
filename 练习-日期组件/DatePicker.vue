...
.picker-panel .picker-arrow::before {
  content: "";
  position: absolute;
  top: 1px;
  left: -6px;
...
.picker-panel .picker-body .picker-header {
  margin: 15px 0;
  display: flex;
  align-items: center;
...
.picker-panel .picker-header .picker-date {
  font-size: 14px;
  user-select: none;
}

.picker-panel .picker-body .picker-content .picker-weeks {
  display: flex;
  height: 40px;
  line-height: 40px;
